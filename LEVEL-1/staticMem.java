...
class Mobile {
    ...
    static String name; // static var is common for all or static name is class's member not object's
                        // member
...
class staticMem {
    ...
    public static void main(String a[]) throws ClassNotFoundException {
        ...
        // m1.brand = "Apple";
        // m1.price = 1500;
        // m1.name = "SmartPhone"; //static create once in memory without object and
        // common for all
